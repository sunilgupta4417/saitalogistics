                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-btns">
                                <div class="form-group text-center custom-mt-form-group">
                                    ...
                                    @if(checkAccess('manage-users','import_permission'))<a href="{{route('export.users',$userstatus)}}" class="btn btn-primary mr-2 btn-sm"><i class="fa fa-expand"> Export</i></a>@endif
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="bg-clr">
                                <div class="row">
                                    ...
                                    <div class="col-md-7">
                                        <form action="{{route('manage.post.user')}}" method="post" style="display: flex;">
                                            @csrf
                                            <input type="hidden" name="filter_role" value="{{$userstatus}}">
                                            <div class="col-md-4">
                                                <div class="searching-fld">
                                                    <select class="form-control select" name="filter_name">
                                            ...
                                            <div class="col-md-3">
                                                <div class="searching-fld">
                                                    <select class="form-control select" name="filter_status">
