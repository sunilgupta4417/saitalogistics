...
<body>
	<div>
		...
		<div style="background: #eceff4;padding: 1.5rem;">
			<table>
				<tr>
					<td>
							...
							<img loading="lazy"  src="https://africuniabank.com/public/images/logos/1611120076_logo.png" height="40" style="display:inline-block;">
			...
			<table>
				<tr>
					<td style="font-size: 1.2rem;" class="strong">Africunia Bank</td>
					<td class="text-right"></td>
				</tr>
				<tr>
					<td class="gry-color small">2nd Floor, 17 King Edwards Road,London HA4 7AE,United Kingdom.</td>
					<td class="text-right"></td>
				</tr>
				<tr>
					<td class="gry-color small">Email: info@africuniabank.com</td>
