    ...
    <div class="page-header">
       <div class="row">
          <div class="col-lg-6 col-md-6 col-sm-6 col-12">
             <h5 class="text-uppercase mb-0 mt-0 page-title">CMS Service Master</h5>
          </div>
          <div class="col-lg-6 col-md-6 col-sm-6 col-12">
             <ul class="breadcrumb float-right p-0 mb-0">
                <li class="breadcrumb-item"><a href="{{ url('/home') }}"><i class="fas fa-home"></i> Dashboard</a></li>
                <li class="breadcrumb-item"><a href="#"> CMS</a></li>
                <li class="breadcrumb-item"><span> Service Master</span></li>
             </ul>
          </div>
       </div>
    </div>
       ...
       <div class="row">
        ...
        @endif
             ...
             @include('message.error_validation')
                ...
                if($content_id!=0){
                    $req = '';
                    $url = route('cms.service.update');
                }else{
                    $req = 'required';
                    $url = route('cms.service.store');
                }
                ?>
                                ...
                                <div class="x_content">
                                    <div class="table-responsive">
                                        <table class="responsive">
                                            ...
                                            <tr>
                                                <td><a class="btn btn-primary" href="{{url('admin/cms/service')}}?id={{$rowu->id}}"> <i class="fa fa-pencil-alt"></i></a></td>
                                                <td><a class="btn btn-primary" href="{{url('admin/cms/service/delete',$rowu->id)}}" onclick="return confirm('Are you sure you want to delete this record?')"> <i class="fa fa-trash-alt"></i></a></td>
