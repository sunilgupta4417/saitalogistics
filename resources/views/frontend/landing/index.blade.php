            ...
            <div class="row align-items-center justify-content-center">
                <div class="col-md-7 col-lg-6">
                    <div class="banner-content">
                        ...
                        <a href="create-your-shipment.html" class="btn btn-main-2">Send Package </a>  
                        <a href="tracking.html" class="btn btn-main-2 track-shipment-clr">Track Shipment </a>  
                    </div>
                </div>
                <div class="col-lg-6 col-md-5">
                    <div class="banner-img mt-5 mt-lg-0">
                        <div id="all">
                            <a id="play-video" class="play-button" data-url="{{$cms->page_image}}" data-toggle="modal" data-target="#myModal" title="XJj2PbenIsU"><img src="assets/images/play-btn.svg" alt="" class="img-responsive"></a>
                        </div>
                        <!-- VIDEO MODAL -->
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4">
                    <div class="pricing-item mb-4 mb-lg-0">
                        ...
                        <a href="{{url('services')}}" class="btn btn-main-2">Read More</a>
                    </div>
                </div> 
                @endforeach
