...
<head>
  ...
  <body style="background-color: #535b61;">
  <div class="invoice-container-wrap" style="width:865px; background: #fff; padding: 20px; margin: 30px auto;">
      <div class="invoice-container">
        ...
        <!-- First Slip Here End -->
        <div class="cut-here" style="background: url(./cut-here.png) no-repeat center; padding: 15px; 0;"> 
